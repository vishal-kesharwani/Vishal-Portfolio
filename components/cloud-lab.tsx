...
const commandMap: Record<string, string[]> = {
  ...
  architecture: [
    ...
    "      -> analytics-service",
    "        -> eks (Kubernetes)",
    "See the hero section above for the live diagram.",
  ],
  "kubectl logs": [
    "==> application-service-7d8c9f6d8f",
    '{"level":"info","msg":"consumed application.events","offset":18240}',
    '{"level":"info","msg":"POST /api/applications 201","latencyMs":42}',
    '{"level":"info","msg":"published analytics.events"}',
    "-- tailing, ctrl+c to stop (this is a static demo) --",
  ],
  "terraform plan": [
    "Refreshing state... [id=eks-jobtracker-cluster]",
    "",
